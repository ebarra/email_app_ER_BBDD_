...
export default class Inbox extends React.Component {
  ...
  render(){
    ...
    return <div className="wrapper">
	    <LeftMenu config={this.props.config} profile={this.props.profile} chats={this.props.chats} selectedCategory={this.state.selectedCategory} getUnreadEmailsFromCategory={this.getUnreadEmailsFromCategory} selectCategory={category=>this.setState({selectedCategory:category})}/>
